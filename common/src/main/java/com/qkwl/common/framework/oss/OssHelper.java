...
public class OssHelper {
	 ...
	 * @return
	 */
	public String uploadValidateFile(byte[] file, String filePath) {
		String result;
		try {
			result = uploadOSS(getBucketValidate(), "image/jpeg", new ByteArrayInputStream(file), file.length, null, filePath);
		} catch (Exception e) {
			return null;
		}
		if (result == null) {
		...
		return redisHelper.getSystemArgs("idcardImgUploadUrl") + result;
	}

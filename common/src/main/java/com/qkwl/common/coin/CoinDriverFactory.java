...
public class CoinDriverFactory {
	...
	public CoinDriver getDriver() {
		...
		case 3: // ETH
			return new ETHDriver(ip, port, pass, coinType, sendAccount, contractAccount, contractWei);
		case 5: // ETC
		...
		case 9: // WICC
			return new WICCDriver(accessKey, secretKey, ip, port, pass, coinType, sendAccount);
		case 10: // USDT
			return new USDTDriver(accessKey, secretKey, ip, port, pass, coinType, sendAccount);
		case 11: // MOAC
			return new MOACDriver(ip, port, pass, coinType, sendAccount, contractAccount, contractWei);
		case 12: // FOD
			return new FODDriver(ip, port, pass, coinType, sendAccount, contractAccount, contractWei);
		case 13: // EOS
			return new EOSDriver(accessKey, secretKey, ip, port, pass, coinType, sendAccount);
		default:
			return null;
		}
	}

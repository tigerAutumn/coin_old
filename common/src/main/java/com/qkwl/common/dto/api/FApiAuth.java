...
public class FApiAuth implements Serializable{
	...
	public String toString() {
		return "FApiAuth [fid=" + fid + ", fuid=" + fuid + ", fapikey=" + fapikey + ", fsecretkey=" + fsecretkey
				+ ", fip=" + fip + ", fstatus=" + fstatus + ", frate=" + frate + ", fopenrate=" + fopenrate
				+ ", fcount=" + fcount + ", frqip=" + frqip + ", fcreatetime=" + fcreatetime + ", fupdatetime="
				+ fupdatetime + "]";
	}

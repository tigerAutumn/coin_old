...
public class ValidateParamInfo implements Serializable{
    ...
    private BusinessTypeEnum emailBusinessType;
    
    public BusinessTypeEnum getEmailBusinessType() {
		return emailBusinessType;
	}

	public void setEmailBusinessType(BusinessTypeEnum emailBusinessType) {
		this.emailBusinessType = emailBusinessType;
	}

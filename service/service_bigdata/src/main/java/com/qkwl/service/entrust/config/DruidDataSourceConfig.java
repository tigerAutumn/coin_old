...
public class DruidDataSourceConfig {
    ...
    public DruidDataSource dataSource(DataSourceProperties dataSourceProperties, DruidDataSourceProperties druidDataSourceProperties) {
    	System.out.println("--------getName------"+dataSourceProperties.getName());
    	System.out.println("--------getUrl------"+dataSourceProperties.getUrl());
    	System.out.println("--------getPassword------"+dataSourceProperties.getPassword());
    	System.out.println("--------getDriverClassName------"+dataSourceProperties.getDriverClassName());

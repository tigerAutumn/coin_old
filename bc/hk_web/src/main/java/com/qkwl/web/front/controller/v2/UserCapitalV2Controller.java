...
public class UserCapitalV2Controller extends JsonBaseController {
	 ...
	 */
	@ResponseBody
    @RequestMapping("/v2/capital/save_withdraw_address")
	 ...
	 */
	@ResponseBody
    @RequestMapping("/v2/capital/list_withdraw_address")
	public ReturnResult getWithdrawAddress(	@RequestParam(required = true) int coinId) throws Exception {
		try{
	 ...
	 */
	@ResponseBody
    @RequestMapping("/v2/capital/remove_withdraw_address")
     ...
     */
    @ResponseBody
    @RequestMapping("/v2/capital/coin_withdraw_info")
    public ReturnResult coinWithdrawInfo(
    	...
    	try {
	        ...
	        jsonObject.put("amountAvailable", userWallet.getTotal());
			...
			logger.error("访问/v2/capital/coin_withdraw_info异常",e);
		}
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/v2/capital/withdraw")
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/v2/capital/check_tradePwd")

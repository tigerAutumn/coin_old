...
@Controller
public class ETHClassRechargeController extends JsonBaseController {
     ...
     */
    @ResponseBody
    @RequestMapping("/coin/ethclass/recharge")
    public String ethRecharge(
        ...
        baseCoinType = redisHelper.getCoinTypeByCoinSort(coinType.getCoinType());

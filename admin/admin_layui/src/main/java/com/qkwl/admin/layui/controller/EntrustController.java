...
public class EntrustController extends WebBaseController {
    ...
    public ModelAndView entrustList(
        ...
        for (SystemTradeType trade : tradeType) {
            tradeMap.put(trade.getId(), trade.getSellName()+"/"+trade.getBuyShortName());
        }
    ...
    public ModelAndView entrustHistoryList(
        ...
        Pagination<FEntrustHistory> minDate = adminEntrustServer.selectFEntrustHistoryList(minDateParam, filterParam);
